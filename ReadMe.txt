...
Finally, Keep in mind that jumping can greatly affect range. always double check your setup by jumping.
If you have plugins that allow for player scaling or crawling, these can also affect range, so be sure to check these too.
